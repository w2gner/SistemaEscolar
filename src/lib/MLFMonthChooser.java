...
======================================================================
Arquivo		:	$RCSfile: MasterMonthChooser.java,v $
Projeto		:	MasterSys
Criação		:	09/03/2011
...
@Matheus 2011-18-04
- Criação da classe para controle de datas.
...
public class MLFMonthChooser extends JPanel {
	...
	/**
	 * Método para ser sobrescrito pela classe que usará este objeto, afim de
