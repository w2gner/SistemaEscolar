 ...
 * 
 *          ======================================================================
 *          Arquivo : $RCSfile: MasterWindowCadastroModalidade.java,v $ Projeto
 *          : MasterSys Criação : 09/03/2011 Descrição : Componente para
 *          tratamento de valores monetarios.
 *          ======================================================================
 * 
 * @Matheus 2011-18-04 - Criação da classe para valores monetarios.
 * 
 */

public class MLFMoneyField extends JFormattedTextField {
	 ...
	 * 
	 * @param an_value Valor numérico.
	 */
	public void setValue(BigDecimal an_value) {
		if (an_value == null) {
			this.setText("0,00");
		} else {
