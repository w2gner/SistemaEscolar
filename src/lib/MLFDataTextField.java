...
======================================================================
Arquivo		:	$RCSfile: MLFDataTextField.java,v $
Projeto		:	MLFLib
Criação		:	13/03/2015
Descrição	:	Campo texto preparado para data.
======================================================================

*/

public class		MLFDataTextField
	...
	*/
	public			MLFDataTextField()
	{
		...
		*/
		...
		/*
		Adiciona evento de foco para que quando o foco chegar no campo o cursor ir para a posição inicial
		*/
		addFocusListener
		(
			new FocusAdapter()
	...
	*/
	...
	{	
		try
		{
			...
			*/
			Date
			lo_data			=	io_formato.parse(getText());
	...
	/**
	Este método pega um objeto Date e converte diretamente para String,
	para mostrar no campo.
	@param	ao_data
		Objeto Date a ser mostrado no campo.
	*/
	public
	void			setDate
				(
