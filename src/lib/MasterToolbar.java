 ...
 * 
 *          ======================================================================
 *          Arquivo : $RCSfile: MasterToolbar.java,v $ Projeto : MasterSys
 *          Cria��o : 21/02/2011 Descri��o : Componente de navegacao.
 *          ======================================================================
 * 
 */
...
public class MasterToolbar extends JPanel {
	...
	// Bot�es.
	//
	public JButton io_btn_buscar, io_btn_adicionar, io_btn_remover, io_btn_salvar;
