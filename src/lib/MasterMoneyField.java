 ...
 *          : MasterSys Cria��o : 09/03/2011 Descri��o : Componente para
 *          tratamento de valores monetarios.
 *          ======================================================================
 * 
 * @Matheus 2011-18-04 - Cria��o da classe para valores monetarios.
 * 
 */
...
public class MasterMoneyField extends JFormattedTextField {
	...
	/**
	 * Retorna o valor num�rico contido no campo.
	 */
	...
	/**
	 * Seta um valor num�rico no campo.
	 * 
	 * @param an_value Valor num�rico.
	 */
